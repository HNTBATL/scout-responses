...
with open('lai10_responses.csv', mode='w', newline="", encoding='utf-8') as sce_file:
    sce_writer = csv.writer(sce_file, delimiter=';')
    sce_writer.writerows(to_csv)

with open('lai10_safety.csv', mode='w', newline="", encoding='utf-8') as sce_safety_file:
    sce_safety_writer = csv.writer(sce_safety_file, delimiter=',')
    sce_safety_writer.writerows(safety_csv)

with open('lai10_type.csv', mode='w', newline="", encoding='utf-8') as sce_type_file:
