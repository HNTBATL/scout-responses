...
for response in survey_responses:
    ...
    comment_location_from = response['comment_location']['starting_from']
    coords_from = pull_density_points(comment_location['starting_from'])
    coords_to = pull_density_points(comment_location['starting_from'])
