...
for response in survey_responses:
    comment_location = response['comment_location']['going_to'] # yields array
    print('comment_location_to_____________________________________________________________________________')
    print(comment_location)
    to_coords = pull_points(comment_location['going_to'])
    from_coords = pull_points(comment_location['starting_from'])
