    ...
    for question in survey_questions:
        ...
        if is_panel_type == 'panel':            
            for q in question["elements"]:
                if q.hasOther == True:
                    questions[q['name-other']] = q.get('name', 'NOTITLE')
                questions[q['name']] = q.get('name', 'NOTITLE')
        else:
            if question.hasOther == True:
                questions[question['name-other']] = question.get('name', 'NOTITLE')
            questions[question['name']] = question.get('name', 'NOTITLE')
    return questions
